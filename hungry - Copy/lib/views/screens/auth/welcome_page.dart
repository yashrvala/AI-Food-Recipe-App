                  ...
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Foodie?', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w700, fontSize: 32, color: Colors.white)),
                      ),
                      Text("Let's Cook Together, Eat Together.", style: TextStyle(color: Colors.white)),
                    ],
                  ),
                  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            text: 'By joining Foodie, you agree to our ',
